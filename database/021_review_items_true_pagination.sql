-- 021_review_items_true_pagination.sql
-- Run after 020_list_review_items_page_2args.sql.
-- Adds true server-side pagination/filtering for the review workspace while
-- keeping the 019/020 RPCs available for compatibility.

create extension if not exists pg_trgm;

create index if not exists review_items_dataset_page_idx
...
create index if not exists review_items_search_trgm_idx
on public.review_items
using gin (
  (
    lower(
